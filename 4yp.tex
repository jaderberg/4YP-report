...
\begin{figure}[htb]
\centering 
\subfloat[Query image]{\label{fig:turboresultqueryimage}\includegraphics[width=0.3\textwidth]{images/turboquery.jpg}}
~
\subfloat[Model image]{\label{fig:turboresultmodelimage}\includegraphics[width=0.3\textwidth]{images/turbomodelimage.pdf}}
~
\subfloat[Turbo image]{\label{fig:turboresultturboimage}\includegraphics[width=0.3\textwidth]{images/turbomatch.pdf}}
\\
