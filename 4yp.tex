...
\begin{tabular}{c|c|c|c|}
\cline{2-4}
 & \multicolumn{3}{|c|}{Inlier Threshold} \\ 
 \cline{2-4}
 & 5 & 7 & 9 \\
 \cline{2-4}
 \cline{1-4}
\multicolumn{1}{|c|}{RANSAC} & \texttt{14.1\%} & \textcolor{red}{\texttt{18.1\%}} & \texttt{14.3\%} \\  
\cline{1-4}
\multicolumn{1}{|c|}{NOSAC} & \textcolor{red}{\texttt{20.8\%}} & \texttt{17.7\%} & \texttt{16.1\%} \\  
\cline{1-4}
\multicolumn{1}{|c|}{Affine} & \textcolor{red}{\texttt{22.3\%}} &  \texttt{17.4\%} & \texttt{13.8\%} \\  
\cline{1-4}
\multicolumn{1}{|c|}{Affine RootSIFT} & \textcolor{red}{\texttt{22.3\%}} &  \texttt{17.4\%} & \texttt{13.8\%} \\  
\cline{1-4}
\end{tabular}
\end{center}
...
As with NOSAC, this is done for every correspondence and the inliers from the best estimation used to compute a final estimate for the transformation. The process is faster than RANSAC and results in a 23\% increase in yield.
