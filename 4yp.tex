...
~
\subfloat[The turbo image matching the model image, resulting in augmentation of the turbo image's visual words]{\label{fig:turboresultturbomatch}\includegraphics[width=0.45\textwidth]{images/model_turbo.pdf}}
\\
