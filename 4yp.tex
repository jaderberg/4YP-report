...
The state of the art as described in \cite{philbin2007} is used as the basis for this project, however adaptations are put in place to be used for the sparse and noisy dataset in this system.
